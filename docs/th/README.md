...
เพื่อใช้ฟังก์ชันเหล่านี้อย่างรวดเร็ว เราจึงได้จัดทำเว็บไซต์ออนไลน์ที่มีความเสถียรสำหรับผู้ใช้ในภาษาต่างๆ ไว้ใช้งาน ยกเว้นเครื่องมือเล็กๆ น้อยๆ ที่อาจต้องการการสนับสนุนจากระบบภายในเครื่องของคุณ เครื่องมือส่วนใหญ่มีอยู่ในอินเทอร์เน็ต

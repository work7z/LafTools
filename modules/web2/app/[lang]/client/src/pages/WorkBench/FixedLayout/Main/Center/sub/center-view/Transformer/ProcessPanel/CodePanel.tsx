...
export default (props: CommonTransformerPassProp & TransformerWithRuntimeProp) => {
    ...
    return <div className='p-2'>
        ...
        <div className="text-center mb-2 mt-4">
            <AnchorButton target='_blank' minimal outlined href={`https://github.com/work7z/LafTools/blob/dev/modules/web2/app/[lang]/client/src/lib/tools/code/${props.extId}.tsx`} intent="none" text={Dot("Ylq2X", "Error Correction")}></AnchorButton>
        </div>

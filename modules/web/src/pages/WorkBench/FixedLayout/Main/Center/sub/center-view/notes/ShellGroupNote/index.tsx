    ...
    return <div className="w100 h100">
        <Allotment ref={e => {
            ...
            <Allotment.Pane preferredSize={500}>
                <div className="">
                    <div className="">
                        <div className={"p-2  " + " border-t-0 " + CSS_TW_LAYOUT_BORDER_Y + ""} style={{ borderTop: 'none' }}>
                            <InputGroup leftIcon="search" placeholder={Dot("E62ej", "Filter Shell Commands")}></InputGroup>
                        </div>
                    ...
                    <div>
                        ...
                        */}
                        <div className={"flex justify-between px-2 py-1 using-edge-ui-bg   " + CSS_TW_LAYOUT_BORDER_Y}>
                    ...
                    <div className="cmd-list">
                        {
                            shellCommands.filter(e => isAllMode || e.tags.includes(activeTag)).map(e => {
                                return <div className={
                                    ...
                                    <div className="w-full">{e.name}
                                        {
                                            e.tags.map(e => {
                                                return <span className="px-1 py-0.5 mx-1 text-xs bg-lime-300 text-gray-700 rounded">{e}</span>
                                            })
                                        }                                    </div>
                                    <div className="w-full overflow-ellipsis whitespace-nowrap">{e.content}</div>
                                </div>
                            })
                        }
                    </div>

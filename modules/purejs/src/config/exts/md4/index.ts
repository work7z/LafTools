...
let v: ExtensionVM = {
  ...
  Actions: [
    {
      Id: "md4.text",
      Label: Dot("xIPqtV", "Get MD4 Hash"),
      Tooltip: Dot("xREFy8", "Click here to encrypt your input text"),
      CallFuncList: Dot("xmd4.ConvertText"),
    },
    // {
    //   Id: "md4.file",
    //   Label: Dot("x5-S-B", "MD4 from File"),
    //   CallFuncList: Dot("xmd4.ConvertFile"),
    // },
  ],
  Info: {
    Id: "md4",
    Label: Dot("x70PnM", "MD4"),
    Description: Dot(
      "s7gKzt",

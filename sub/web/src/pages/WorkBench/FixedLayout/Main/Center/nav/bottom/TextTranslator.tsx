...
let EachTranslatorBlock = (props: { inputId: string, type: SrcTarget }) => {
  let placeholder = props.type == 'source' ? Dot("L4Lm1", "Please input your source text in this editor.") : Dot("HEAhr", "After translating, the result will appear here.")
  return (
    <div className="h-full w-full inline-block ">
      <GenCodeMirror placeholder={placeholder} lineWrap={true} bigTextId={props.inputId} key={''}></GenCodeMirror>
    </div>
...
export default () => {
  ...
  return <div className='h-full w-full'>
    <div className=' relative flex flex-row justify-between items-center  px-2' style={{
      ...
      <div className='absolute left-[50%] ' style={{
        transform: 'translateX(-50%)'
      }}>
        <LanguageChooser label={Dot("jJuNz", "Source Language")}></LanguageChooser>
        <Button minimal small intent='none' icon='swap-horizontal'></Button>
        <LanguageChooser label={Dot("TwFcr", "Target Language")}></LanguageChooser>
      </div>
      <div>

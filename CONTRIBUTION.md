...
For instance, if you want to convert a base64 into plain text, we should always do the conversion on the server side although there’s a quicker way to do it in the browser directly, which takes user experiences and tool compatibility into consideration.
...
- Any label, text or messages that will be visible to users in the Backend or Frontend side should be wrriten in English.
- 
...
- How to develop F/E project?
- How to develop B/E project?
